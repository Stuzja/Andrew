    ...
    public partial class Form1 : Form
    {
        ...
        private void Andrew()
        {
            ...
            for (int i = 1; i < totalPoints; ++i)
            {
                ...
                {
                    while (upperHull.Count >= 2 && CrossProduct(upperHull[upperHull.Count - 2], upperHull[upperHull.Count - 1], currentPoint) >= 0)
                    {
                ...
                if (i == totalPoints - 1 || CrossProduct(leftmostPoint, currentPoint, rightmostPoint) > 0)
                {
                    while (lowerHull.Count >= 2 && CrossProduct(lowerHull[lowerHull.Count - 2], lowerHull[lowerHull.Count - 1], currentPoint) <= 0)
                    {
